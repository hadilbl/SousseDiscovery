<?php
    ...
    if (isset ($_GET['id'])):
        $idVisite = $_GET['id'];
        $Visite = $destinationfct->getById($idVisite);
    else:
        echo "Identifiant du visite non spécifié.";
    endif;
?>
    ...
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
        <p class="breadcrumbs">
          ...
          <span class="mr-2"><a href="destination.php">Visite <i class="fa fa-chevron-right"></i></a></span>
          <span>Visite Details<i class="fa fa-chevron-right"></i></span>
        </p>
  ...
  <div class="container">
    <div class="row ">
      <div class="col-lg-12 ftco-animate py-md-5 mt-md-5 fadeInUp ftco-animated">
        <h2 class="mb-3"><?= $Visite['nom'] ; ?></h2>
        <p><?= $Visite['description'] ; ?></p>
      </div>
      <div class="col-md-12 d-flex justify-content-center">
        <p><img src="images/<?= $Visite['image'] ; ?>" alt="<?= $Visite['nom'] ; ?>" class="img-fluid"></p>
      </div>
      <div class="col-lg-6">
      ...
      <div class="col-lg-6 ">
        <div class="sidebar-box ftco-animate">
          <div class="categories">
            ...
            <ul>
              <li><a href="#">Nom <span><?= $Visite['nom'] ; ?></span></a></li>
              <li><a href="#">Localisation <span><?= $Visite['localisation'] ; ?></span></a></li>
              <li><a href="#">Type <span><?= $Visite['type'] ; ?></span></a></li>
              <li><a href="#">Prix <span><?= $Visite['prix'] ; ?></span></a></li>
            </ul>
          </div>
        </div>
        <p class="text-center mb-0"><a href="booking.php?type=Destination&id=<?= $Visite['id']; ?>" class="btn btn-primary px-5 py-3">Réserver</a></p>
      </div>
    </div> <!-- .col-md-8 -->
  </div>
</section> <!-- .section -->
