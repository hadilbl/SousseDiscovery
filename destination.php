      ...
      <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
         <div class="col-md-9 ftco-animate pb-5 text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Acceuil <i
                        class="fa fa-chevron-right"></i></a></span> <span>Liste Des Visites <i
            ...
            <div class="col-md-4 ftco-animate">
               <div class="project-wrap">
                  ...
                  <div class="text p-4">
                     ...
                     <ul>
                        <li><span class="flaticon-mountains"></span>
                           <?= $item["type"]; ?>
                        </li>
      ...
      <div class="row justify-content-center">
         <div class="col-md-12 text-center">
            <div class="img" style="background-image: url(images/sousse1.jpg);">
               ...
               <p class="mb-0"><a href="contact.php" class="btn btn-primary px-4 py-3">Contacrez-Nous</a></p>
            </div>
         </div>
      </div>
   </div>
